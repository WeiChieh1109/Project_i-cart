...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-4 text-left addbtn">
			<button>
				<a href="DashBoard.jsp">總統計</a>
			</button>
			<button>
				<select name="selectType" id="selectType">
					<option value="洗面乳">洗面乳</option>
					<option value="化妝品">化妝品</option>
					<option value="衛生棉">衛生棉</option>
					<option value="刮鬍刀">刮鬍刀</option>
			...
			<script>
				chooseTypeFunc();
				$("#selectType").change(chooseTypeFunc);
					function chooseTypeFunc(){
						for(let i=1; i<13 ; i++){
							$("#a"+i).attr("href","ResultTypeServlet?month=2022-"+i+"-"+"&type=" + $("#selectType").val());
						}
					}
			</script>
			</button>
...
<!-- 右上方新增按鈕 -->
		<div class="col-8 text-center listbtn">
			<button id="bt">
		...
		<div style="max-width: 120px;" class="mthbtn col-2 text-left">
			<button>
				<a id="a1" href="ResultTypeServlet?month=2022-01-">01月</a>
			</button>
			<button>
				<a id="a2" href="ResultTypeServlet?month=2022-02-">02月</a>
			</button>
			<button>
				<a id="a3" href="ResultTypeServlet?month=2022-03-">03月</a>
			</button>
			<button>
				<a id="a4" href="ResultTypeServlet?month=2022-04-">04月</a>
			</button>
			<button>
				<a id="a5" href="ResultTypeServlet?month=2022-05-">05月</a>
			</button>
			<button>
				<a id="a6" href="ResultTypeServlet?month=2022-06-">06月</a>
			</button>
			<button>
				<a id="a7" href="ResultTypeServlet?month=2022-07-">07月</a>
			</button>
			<button>
				<a id="a8" href="ResultTypeServlet?month=2022-08-">08月</a>
			</button>
			<button>
				<a id="a9" href="ResultTypeServlet?month=2022-09-">09月</a>
			</button>
			<button>
				<a id="a10" href="ResultTypeServlet?month=2022-10-">10月</a>
			</button>
			<button>
				<a id="a11" href="ResultTypeServlet?month=2022-11-">11月</a>
			</button>
			<button>
				<a id="a12" href="ResultTypeServlet?month=2022-12-">12月</a>
			</button>
		</div>
    ...
    -->
      ...
      var listAdMonth1 = ['日總廣告次數'];
      var listAdMonth = listAdMonth1.concat(${totalAdMonth});
